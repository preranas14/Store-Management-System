...
{	
	...
	if(!empty($_POST['Email']) && !empty($_POST['pass']))
	{
		...
		$result = mysqli_query($conn,"SELECT * FROM admin where Email = '$username' and Password = '$password'") 
 ...
 ?>
	...
	<form class = "form1" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
		<input class = "un" type="Email" name="Email" id = "Email" placeholder = "Email">
